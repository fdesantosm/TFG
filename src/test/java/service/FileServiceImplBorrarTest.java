...
public class FileServiceImplBorrarTest {
  @Autowired
  ...
  void uploadFile_whenFileIsOkey_shouldReturn201() throws Exception {
    ...
    mockMvc.perform(MockMvcRequestBuilders.multipart("/tfg/file/upload")
        .file(spyFile)
    ...
    Mockito.verify(fileService).createFileEntity(
  ...
  void downloadFile_whenFileExists_shouldReturn200() throws Exception {
    ...
    mockMvc.perform(MockMvcRequestBuilders.get("/tfg/file/download/" + token)
